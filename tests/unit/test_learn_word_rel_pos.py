...
_CASES: List[Tuple[str, Iterable[Tuple[Tuple[str, str], Tuple[float, float]]], int]] = [
    (
        "word more more more",
        [
...
@pytest.mark.parametrize(("in_text", "tests", "max_look_dist"), _CASES)
def test_unsigned_symmetry(in_text: str, tests: Dict[Tuple[str, str], float], max_look_dist: int):
...
@pytest.mark.parametrize(("in_text", "tests", "max_look_dist"), _CASES)
def test_signed_antisymmetry(in_text: str, tests: Dict[Tuple[str, str], float], max_look_dist: int):
...
@pytest.mark.parametrize(("in_text", "tests", "max_look_dist"), _CASES)
def test_values_unsigned(in_text: str, tests: Dict[Tuple[str, str], Tuple[float, float]], max_look_dist: int):
...
@pytest.mark.parametrize(("in_text", "tests", "max_look_dist"), _CASES)
def test_values_signed(in_text: str, tests: Dict[Tuple[str, str], Tuple[float, float]], max_look_dist: int):
